...
import com.jfinal.weixin.controller.MovieController;
...
//        ApiConfigKit.setAccessTokenCache(new RedisAccessTokenCache("weixin"));
        ...
        ac.setEncodingAesKey(PropKit.get("encodingAesKey", "qksC0pekEYb2m0OcUphH8Wp4MzpDsGRunX2ZewFOY4x"));
...
//        }
        ...
        wc.setAppId("wx81d6ff87666d7962");
        wc.setAppSecret("793990b1ef8c7f29ea0cbefa73cb002a");
